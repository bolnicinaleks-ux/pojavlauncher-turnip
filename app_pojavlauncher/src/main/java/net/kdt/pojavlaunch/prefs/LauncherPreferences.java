...
public class LauncherPreferences {
    ...
    public static String PREF_CUSTOM_TURNIP_DRIVER = "default";
    ...
    public static void loadPreferences(Context ctx) {
        ...
        PREF_CUSTOM_TURNIP_DRIVER = DEFAULT_PREF.getString("customTurnipDriver", "default");
        PREF_ZINK_PREFER_SYSTEM_DRIVER = "system".equals(PREF_CUSTOM_TURNIP_DRIVER) || DEFAULT_PREF.getBoolean("zinkPreferSystemDriver", false);
